...
Route::middleware(['auth', \App\Http\Middleware\EnsureAdminRole::class])->prefix('app/admin')->group(function () {
    ...
    Route::get('/mpesa-guide', \App\Livewire\AdminApp\MpesaGuide::class)->name('app.admin.mpesa-guide');
    Route::get('/mpesa-channels', \App\Livewire\AdminApp\MpesaChannels::class)->name('app.admin.mpesa-channels');
    ...
    Route::get('/bill-types', \App\Livewire\AdminApp\BillTypes::class)->name('app.admin.bill-types');
    Route::get('/announcements', \App\Livewire\AdminApp\Announcements::class)->name('app.admin.announcements');
    ...
    Route::get('/analytics', \App\Livewire\AdminApp\Analytics::class)->name('app.admin.analytics');
