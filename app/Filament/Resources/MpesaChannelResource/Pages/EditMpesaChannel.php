    ...
    protected function getHeaderActions(): array
    {
        return [
            Actions\Action::make('register_c2b')
                ...
                ->modalDescription('This tells Safaricom to send Paybill payment confirmations for this shortcode to Renty. Use sandbox first if you\'re not sure your credentials are correct.')
