<x-layouts.marketing :title="'Privacy Policy'">
    <section class="max-w-3xl mx-auto px-6 py-20 text-slate-700 leading-relaxed space-y-6">
        ...
        <div>
            ...
            <p>
                Account details (name, email, phone number), property and tenancy records entered by Property Owners,
        ...
        <div>
            ...
            <p>
                ...
                you about your account, and to improve the product. Property Owner data is never visible to other
        ...
        <div>
            ...
            <p>
                With a Property Owner's configuration, we send SMS and email notifications on their behalf (invoices,
        ...
        <div>
            ...
            <p>
                Property Owners control retention of their own tenant/property records. Vacated tenant records are
