<x-layouts.marketing :title="'List your property'">
    ...
    <section class="max-w-6xl mx-auto px-6 py-24">
        <div class="text-center max-w-2xl mx-auto">
            <h2 class="text-3xl font-bold text-slate-900 dark:text-slate-100">Simple, transparent pricing</h2>
            <p class="mt-3 text-slate-500 dark:text-slate-400">Pick the plan that fits your portfolio. Upgrade anytime.</p>
        </div>

        @if ($packages->isEmpty())
            <p class="mt-10 text-center text-slate-500 dark:text-slate-400">Pricing is being finalized - contact us to get started.</p>
        @else
        ...
        <p class="mt-8 text-center">
            <a href="{{ route('pricing') }}" class="text-emerald-700 dark:text-emerald-400 font-semibold hover:underline">See full plan comparison &rarr;</a>
        </p>
    </section>
    ...
    <section class="bg-white border-y border-slate-200 dark:bg-slate-900 dark:border-slate-800">
        <div class="max-w-6xl mx-auto px-6 py-24">
            <div class="text-center max-w-2xl mx-auto">
                <h2 class="text-3xl font-bold text-slate-900 dark:text-slate-100">Trusted by property managers across Nairobi</h2>
            </div>
