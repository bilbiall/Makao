<x-layouts.marketing :title="'Book a stay'">
    <div class="pb-14">
        ...
        <div class="mx-auto max-w-6xl px-4 py-6 sm:px-6">
            <h1 class="text-2xl font-semibold tracking-tight text-slate-900">Furnished stays</h1>
            ...
            @else
                <div class="mt-6 rounded-2xl border border-slate-200 bg-white p-10 text-center shadow-sm">
                    ...
                    <h2 class="mt-4 text-lg font-semibold text-slate-900">Nothing free for those dates</h2>
                    ...
                    <div class="mt-6 flex flex-col justify-center gap-3 sm:flex-row">
                        ...
                        <a href="{{ route('listings.index') }}" class="rounded-lg border border-slate-300 bg-white px-6 py-3 text-sm font-semibold text-slate-700 hover:bg-slate-50">
