        ...
        @elseif ($activeTab === 'templates')
            @php
                $templateFields = [
                    ...
                    'template_tenant_reminder' => ['Tenant Reminder Template', 'Sent by "Resend invite" once a tenant already has an account - a login reminder instead of a join code. Variables: {tenant_name}, {property_name}, {login_url}, {app_name}'],
