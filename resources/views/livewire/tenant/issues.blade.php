    ...
    @if ($showForm)
        <div class="rounded-2xl bg-white border border-slate-200 shadow-sm p-4 space-y-3">
            <div>
                ...
                <input type="text" wire:model="title" placeholder="e.g. Leaking kitchen tap" class="mt-1 w-full rounded-lg border border-slate-300 px-3 py-2 text-sm">
            ...
            <div>
                ...
                <textarea wire:model="description" rows="3" placeholder="Describe the issue in detail" class="mt-1 w-full rounded-lg border border-slate-300 px-3 py-2 text-sm"></textarea>
    ...
    <div class="space-y-3">
        @forelse ($issues as $issue)
            <div class="rounded-2xl bg-white border border-slate-200 shadow-sm p-4">
                ...
                <p class="mt-2 text-sm text-slate-600">{{ $issue->description }}</p>
